...
function FormLabel({
  ...
  return (
    <Text
      style={[
        textStyles.label,
        { color: colors.textSecondary, fontSize: 10, marginBottom: 6 },
      ]}
    >
      {text}
...
export default function NewRecipeScreen() {
  ...
  const [inputMode, setInputMode] = useState<"percentage" | "weight">(
    "percentage",
  );
  ...
  const addIngredient = useCallback(() => {
    ...
    setIngredients((prev) => [
      ...prev,
      { id: newId, name: "", percentage: 0, unit: "g", group: "liquids" },
    ]);
  ...
  const handleSubmit = () => {
    ...
    Alert.alert(
      "Recipe Saved",
      `${recipeName} has been saved! (Check console for data)`,
      ...
      >
        ...
        >
              ...
              >
                ...
                <View style={styles.ingredientCardHeader}>
                  <Text
                    style={[
                      textStyles.label,
                      { color: colors.textAccent, fontSize: 10 },
                    ]}
                  >
                    Ingredient {index + 1}
                  </Text>
                  <Pressable
                    ...
                    style={({ pressed }) => ({
                      opacity:
                        ingredients.length === 1 ? 0.3 : pressed ? 0.5 : 1,
                    })}
                  >
                    <Text
                      style={{
                ...
                <View style={{ marginTop: spacing.sm }}>
                  ...
                  <FormInput
                    ...
                    onChangeText={(t) =>
                      updateIngredientField(index, "name", t)
                    }
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Pressable
                      onPress={() => {
                        ...
                        const currentIdx = groupValues.indexOf(
                          ingredient.group,
                        );
                        const next =
                          groupValues[(currentIdx + 1) % groupValues.length];
                    ...
                    >
                      <Text
                        style={[textStyles.body, { color: colors.textAccent }]}
                      >
                        {ingredient.group} ↕
                      </Text>
                    </Pressable>
          ...
          <View
            style={[
              styles.submitRow,
              { marginBottom: spacing.xxxl, gap: spacing.sm },
            ]}
          >
            <Pressable
            ...
            <Link href="/" asChild>
              ...
              >
                <Text
                  style={[textStyles.button, { color: colors.textSecondary }]}
                >
                  Cancel
                </Text>
              </Pressable>
