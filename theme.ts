...
// ─────────────────────────────────────────────────────────────────────────────
// TYPOGRAPHY
// Load via expo-font in your app/_layout.tsx:
//   useFonts({ 'PlayfairDisplay-Regular': require('./assets/fonts/PlayfairDisplay-Regular.ttf'), ... })
// Download from: https://fonts.google.com/specimen/Playfair+Display
//                https://fonts.google.com/specimen/Inter
// ─────────────────────────────────────────────────────────────────────────────
export const fonts = {
  main:          'Inter',
  mainMedium:    'Inter-Medium',
  mainSemiBold:  'Inter-SemiBold',
  mainBold:      'Inter-Bold',
...
export const shadows = {
  ...
  card: Platform.select({
    ios:     { shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.50, shadowRadius: 15 },
    android: { elevation: 12 },
    default: {},
  }),
  lg: Platform.select({
    ios:     { shadowColor: '#000', shadowOffset: { width: 0, height: 20 }, shadowOpacity: 0.60, shadowRadius: 25 },
    android: { elevation: 20 },
    default: {},
  }),
  cardLight: Platform.select({
    ios:     { shadowColor: '#8b7355', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.18, shadowRadius: 12 },
    android: { elevation: 6 },
    default: {},
  }),
} as const;
